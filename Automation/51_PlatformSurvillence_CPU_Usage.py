...
def PlatformSurvillence(FolderName):
    ...
    print(f"Log Files gets Succesfully created with name {FileName}")

    fobj.write(Border+"\n")
    fobj.write("-----Marvellous Platfrom Survillence Sysytem------\n")
    fobj.write("Log File gest created at:"+timestamp+"\n")
    fobj.write(Border+"\n")
...
def main():
    ...
    # Acual Project Code
        ...
        print("Prss Ctrl+C to abort the Automation Script")
